...
//     <section
//       id="basecamp"
//       className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-bl from-blue-900 to-orange-600 px-4 text-center relative overflow-hidden rounded-3xl"
//     >
