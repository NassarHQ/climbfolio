  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition-all duration-500 ${
        scrolled
          ? "bg-grey-900/90 backdrop-blur-xl border-b border-gray-200/10 shadow-xl"
          : "bg-grey-900/80 backdrop-blur-md"
      }`}
    >
      <div className="bg-gradient-to-tr from-blue-900 to-orange-600 rounded-full backdrop-blur-md px-4 py-1 flex justify-evenly items-center">
